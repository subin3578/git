    ...
    <main>
        <div class="hello">
            ...
            <aside>
                ...
                <ul class="asidelnb">
                    <li>
                        <li class="lnb1"><a href="#"><img id="lnb1" src="../img/sub_cate1_lnb1_ov.png" alt="cate_lnb1"></a></li>
                        <li class="lnb2"><a href="#"><img id="lnb2" src="../img/sub_cate1_lnb2.png" alt="cate_lnb2"></a></li>
